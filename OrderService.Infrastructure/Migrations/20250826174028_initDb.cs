        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Endpoint = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceJob", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdempotencyKey_Key_Endpoint",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceJob_NextAttemptAt",
                table: "InvoiceJob",
